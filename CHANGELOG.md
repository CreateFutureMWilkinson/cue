...
- **Fairy body too large and too dim** — Body circle reduced from 10% to 5% of jar width. Body color brightened from dark green `#006100` to bright green `#00FF00`, making the core visually distinct from the surrounding glow. Glow layers retain original dark green color. (Phase-5-Feature-051)
