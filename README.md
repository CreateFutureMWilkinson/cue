...
Phases 1–3 complete. Phase 4 (Dynamic Service Config + Settings UI) in progress — Features 031–032 (ServiceConfig interface + SQLite implementation) done. See [docs/Roadmap.md](docs/Roadmap.md) for full implementation status.
