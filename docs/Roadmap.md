...
|---|---|---|---|---|
| 031 | ServiceConfig repository interface | Planned | — | [Feature-031](features/phase-4/Feature-031-ServiceConfig-Repository.md) |
| 032 | SQLite ServiceConfig implementation | Planned | 031 | [Feature-032](features/phase-4/Feature-032-SQLite-ServiceConfig.md) |
