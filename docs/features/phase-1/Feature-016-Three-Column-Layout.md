# Feature 016 — Three-Column Layout + Center View Router
...
| Focus rail is placeholder | Feature 017 populates it with timer ring and navigation buttons |
| Removed "Review Buffered" button | Moves to notification panel expand state in Feature 018 |
...
const (
    ...
    ViewPlan                          // Day planner (Feature 022)
...
| Feature | Dependency |
|---|---|
| Feature 017 (Focus Rail) | Populates the left column placeholder; reads CenterViewRouter for Back/Plan button visibility |
| Feature 018 (Notification Redesign) | Occupies right column; expand toggle hides center area |
| Feature 019 (Activity Log Drawer) | Activity log becomes a drawer within the center column |
| Feature 022 (Planner UI) | Registers ViewPlan and ViewWizard with CenterViewRouter |
